...
int LSM9DS1Class::begin()
{
  ...
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG1_G, 0xD8); // 119 Hz, 2000 dps, 16 Hz BW // 952 Hz
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG6_XL, 0xC8); // 119 Hz, 4G // 952 Hz, 16G, 408 Hz
